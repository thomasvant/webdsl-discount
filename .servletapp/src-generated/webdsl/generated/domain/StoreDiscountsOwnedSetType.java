...
@SuppressWarnings("unchecked")public class StoreDiscountsOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new StoreDiscountsSet(anticipatedSize<1?0:anticipatedSize);
}
