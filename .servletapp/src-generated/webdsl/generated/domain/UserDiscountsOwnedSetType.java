...
@SuppressWarnings("unchecked")public class UserDiscountsOwnedSetType extends utils.AbstractOwnedSetType{
private static final String[] _filters=(String[])null;
@Override public Object instantiate(int anticipatedSize){
return new UserDiscountsSet(anticipatedSize<1?0:anticipatedSize);
}
