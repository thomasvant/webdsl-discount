...
thepage.invalidateAllPageCache("dummy_webdsl_entity"+"."+prop);
}
}
if(thepage!=null&&thepage.isReadOnly){
org.webdsl.logging.Logger.warn("page or ajax template is forced to be read-only, but a persisted entity property is attempted to be updated in "+"dummy_webdsl_entity"+"."+prop);
...
return webdsl.generated.domain.dummy_webdsl_entity._static_cast_(utils.PageParamLoad.loadEntity(utils.HibernateUtil.getCurrentSession(),"webdsl.generated.domain"+"."+"dummy_webdsl_entity",prop_));
}
...
public static dummy_webdsl_entity _static_cast_(Object o){
return (dummy_webdsl_entity)org.webdsl.tools.Utils.cast(o,dummy_webdsl_entity.class);
}
}
