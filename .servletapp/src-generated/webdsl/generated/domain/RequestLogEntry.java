...
thepage.invalidateAllPageCache("RequestLogEntry"+"."+prop);
}
}
if(thepage!=null&&thepage.isReadOnly){
org.webdsl.logging.Logger.warn("page or ajax template is forced to be read-only, but a persisted entity property is attempted to be updated in "+"RequestLogEntry"+"."+prop);
...
public RequestLogEntry setPrincipal(webdsl.generated.domain.User newitem){
...
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._name = :param0").setParameter("param0",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByNameLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._name like :param1").setParameter("param1",s_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByRequestedURL_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._requestedURL = :param2").setParameter("param2",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByRequestedURLLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._requestedURL like :param3").setParameter("param3",s_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByClientIP_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._clientIP = :param4").setParameter("param4",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByClientIPLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._clientIP like :param5").setParameter("param5",s_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByMethod_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._method = :param6").setParameter("param6",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByMethodLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._method like :param7").setParameter("param7",s_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByReferer_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._referer = :param8").setParameter("param8",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByRefererLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._referer like :param9").setParameter("param9",s_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByUserAgent_(String prop_){
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._userAgent = :param10").setParameter("param10",prop_).list();
}
public static java.util.List<webdsl.generated.domain.RequestLogEntry> _static_findByUserAgentLike_(String prop_){
String s_="%"+prop_+"%";
return utils.HibernateUtil.getCurrentSession().createQuery("select g from RequestLogEntry as g where g._userAgent like :param11").setParameter("param11",s_).list();
}
public static webdsl.generated.domain.RequestLogEntry _static_load_(java.util.UUID prop_){
return webdsl.generated.domain.RequestLogEntry._static_cast_(utils.PageParamLoad.loadEntity(utils.HibernateUtil.getCurrentSession(),"webdsl.generated.domain"+"."+"RequestLogEntry",prop_));
}
...
public static RequestLogEntry _static_cast_(Object o){
return (RequestLogEntry)org.webdsl.tools.Utils.cast(o,RequestLogEntry.class);
}
}
