...
public @SuppressWarnings("all")class root_ta0_Template extends utils.TemplateServlet{
...
if(RENDER_PHASE==phase){
utils.RenderUtils.printPageString("Hello world",out,threadLocalPageCached.isRawoutput());
}
if(RENDER_PHASE==phase){
out.print("</"+"h1"+">");
}
