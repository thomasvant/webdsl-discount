...
@SuppressWarnings("all")public class RefArg_inputSecret_1_register_ta0User_Secretpc2 extends utils.RefArg{
public webdsl.generated.domain.User user_;
public  RefArg_inputSecret_1_register_ta0User_Secretpc2(){}
public  RefArg_inputSecret_1_register_ta0User_Secretpc2(Object user_){
this.user_=(webdsl.generated.domain.User)user_;
}
public webdsl.generated.domain.User set(Object obj){
user_.setPassword((String)org.webdsl.tools.Utils.cast(obj,String.class));
return user_;
}
public Object get(){
return (String)user_.getPassword();
}
...
return user_.getId()+"!"+"RefArg_inputSecret_1_register_ta0User_Secretpc2";
}
...
user_.validatePassword_internalValidationExceptionMultiple_(vem);
